...
import AddEmployeePaySlip from "./SalaryComponent/AddEmployeePaySlip";
import ViewEmployeePayslip from "./SalaryComponent/ViewEmployeePayslip";
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/employee/payslip/add" element={<AddEmployeePaySlip />} />
        <Route
