...
//		}
		...
		userDetailToUpdate.setEmploymentCode(registerRequest.getEmploymentCode());
		userDetailToUpdate.setCompanyEmail(registerRequest.getCompanyEmail());
		userDetailToUpdate.setOfficePhone(registerRequest.getOfficePhone());
		userDetailToUpdate.setOfficeAddress(registerRequest.getOfficeAddress());
		userDetailToUpdate.setReportingManager(registerRequest.getReportingManager());
		userDetailToUpdate.setHrName(registerRequest.getHrName());
		userDetailToUpdate.setDateOfJoining(registerRequest.getDateOfJoining());
		
//		//Update Project Details
//		
//		userDetailToUpdate.setProjectCode(registerRequest.getProjectCode());
//		userDetailToUpdate.setStartDate(registerRequest.getStartDate());
//		userDetailToUpdate.setendDate(registerRequest.getProjectCode());
//		userDetailToUpdate.setClientProjectName(registerRequest.getClientProjectName());
//		userDetailToUpdate.setReportingMngMail(registerRequest.getReportingMngMail());
