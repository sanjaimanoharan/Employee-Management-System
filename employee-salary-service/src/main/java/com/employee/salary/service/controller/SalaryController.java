...
public class SalaryController {
	...
	public ResponseEntity<CommonApiResponse> addUserSalaryPaySlip(@RequestBody PaySlip paySlip) {

		return salaryResource.addSalaryPaySlipForUser(paySlip);

	}

	@GetMapping("/user/payslip/fetch")
	public ResponseEntity<SalaryResponseDto> getUserSalaryPayslipDetails(@RequestParam("userId") int userId) {

		return salaryResource.fetchSalaryPaySlipDetailsUsingUserId(userId);
